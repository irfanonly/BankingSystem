...
namespace BankingSystem.Migrations
{
    ...
    [Migration("20241009072805_RemarksNullableAddedOnTransfer")]
    partial class RemarksNullableAddedOnTransfer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BankingSystem.Data.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a79d414c-9daa-480a-a2de-b088a97a9ec5"),
                            AccountTypeId = 1,
                            Balance = 5000.00m,
                            IsClosed = false,
                        ...
                        new
                        {
                            Id = new Guid("eeb614d5-8457-46f8-846f-99724425f1c8"),
                            AccountTypeId = 2,
                            Balance = 15000.00m,
                            IsClosed = false,
                        ...
                        new
                        {
                            Id = new Guid("fd589f85-930a-4217-a1fe-33f6db2b2f54"),
                            AccountTypeId = 1,
                            Balance = 25000.00m,
                            IsClosed = false,
            ...
            modelBuilder.Entity("BankingSystem.Data.AccountType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2024, 10, 9, 7, 28, 5, 310, DateTimeKind.Utc).AddTicks(117),
                            IsDeleted = false,
                            Name = "Savings",
                            UpdatedOn = new DateTime(2024, 10, 9, 7, 28, 5, 310, DateTimeKind.Utc).AddTicks(119)
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2024, 10, 9, 7, 28, 5, 310, DateTimeKind.Utc).AddTicks(121),
                            IsDeleted = false,
                            Name = "Checking",
                            UpdatedOn = new DateTime(2024, 10, 9, 7, 28, 5, 310, DateTimeKind.Utc).AddTicks(121)
                        });
                });
            ...
            modelBuilder.Entity("BankingSystem.Data.Transaction", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            AccountId = new Guid("a79d414c-9daa-480a-a2de-b088a97a9ec5"),
                            Amount = 500.00m,
                            TrnMethod = "Deposit",
                            TrnOn = new DateTime(2024, 10, 9, 11, 28, 5, 310, DateTimeKind.Local).AddTicks(244),
                            TrnType = "Credit"
                        },
                        new
                        {
                            ...
                            TrnOn = new DateTime(2024, 10, 7, 11, 28, 5, 310, DateTimeKind.Local).AddTicks(254),
                            TrnType = "Debit"
                        },
                        new
                        {
                            Id = 3L,
                            AccountId = new Guid("eeb614d5-8457-46f8-846f-99724425f1c8"),
                            Amount = 2000.00m,
                            TrnMethod = "Deposit",
                            TrnOn = new DateTime(2024, 10, 4, 11, 28, 5, 310, DateTimeKind.Local).AddTicks(259),
                            TrnType = "Credit"
                        },
                        new
                        {
                            Id = 4L,
                            AccountId = new Guid("fd589f85-930a-4217-a1fe-33f6db2b2f54"),
                            Amount = 5000.00m,
                            TrnMethod = "Deposit",
                            TrnOn = new DateTime(2024, 9, 9, 11, 28, 5, 310, DateTimeKind.Local).AddTicks(261),
                            TrnType = "Credit"
                        },
                        new
                        {
                            ...
                            Amount = 3000.00m,
                            TrnMethod = "Deposit",
                            TrnOn = new DateTime(2024, 8, 9, 11, 28, 5, 310, DateTimeKind.Local).AddTicks(265),
                            TrnType = "Credit"
                        });
                });
